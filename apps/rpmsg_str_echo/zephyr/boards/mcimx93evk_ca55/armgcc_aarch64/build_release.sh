...
do
	...
	do
		...
		cmake -B build_RTOS${each_rtos}_${each_console} -GNinja -DZEPHYR_MODULES="$CMSIS_PATH;$HAL_NXP_PATH;$OPENAMP_PATH;$LIBMETAL_PATH" -DRTOS_ID=${each_rtos} -DCONSOLE=${each_console} -DBOARD=imx93_evk/mimx9352/a55  ../../../
		...
		mv build_RTOS${each_rtos}_${each_console}/zephyr/rpmsg_str_echo.bin build_RTOS${each_rtos}_${each_console}/zephyr/rpmsg_str_echo_ca55_RTOS${each_rtos}_${console_name}.bin
		mv build_RTOS${each_rtos}_${each_console}/zephyr/rpmsg_str_echo.elf build_RTOS${each_rtos}_${each_console}/zephyr/rpmsg_str_echo_ca55_RTOS${each_rtos}_${console_name}.elf
	done
done
