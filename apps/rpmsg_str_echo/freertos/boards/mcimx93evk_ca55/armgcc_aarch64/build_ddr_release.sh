...
do
	...
	do
		...
		if [ $each_console = "RAM_CONSOLE" ]; then
			...
			gcc -o  CMakeFiles/get_ram_console_addr -DRTOSID=${each_rtos} -I../../../../../../os/freertos/Core_AArch64/boards/mcimx93evk/ ../../../../../../tools/helper/get_ram_console_addr.c
			buf_addr=$(./CMakeFiles/get_ram_console_addr)
			mv ddr_release/rpmsg_str_echo_ca53_RTOS${each_rtos}_${each_console}.bin ddr_release/rpmsg_str_echo_ca55_RTOS${each_rtos}_${each_console}-${buf_addr}.bin
			mv ddr_release/rpmsg_str_echo_ca53_RTOS${each_rtos}_${each_console}.elf ddr_release/rpmsg_str_echo_ca55_RTOS${each_rtos}_${each_console}-${buf_addr}.elf
		fi
	done
done
