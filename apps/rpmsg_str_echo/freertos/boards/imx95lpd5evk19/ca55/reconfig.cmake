...
if (NOT DEFINED CONSOLE)
    message("warning: CONSOLE is not defined, set to UART3 by default")
    set(CONSOLE "UART3")
endif()
...
mcux_add_custom_command(
    ...
    BUILD_COMMAND ${CMAKE_C_COMPILER} -E -P -x assembler-with-cpp -I${SdkRootDirPath}/${hmc_os_board_path} -DRTOSID=${RTOS_ID} -o ${DDR_LD_FILE}  ${SdkRootDirPath}/${hmc_os_board_path}/armgcc_aarch64/MIMX9596xxxxx_ca55_ddr_ram.ld.S
)
