...
The SRTM(Simplified Real Time Messaging) protocol is used to achieve this. LPUART5 on MCIMX93-EVK
...
Connect LPUART5 to host PC using USB To TTL serial cable.
    ...
    LPUART5 RX:  Pin 27 of J1001
    LPUART5 TX:  Pin 28 of J1001
    LPUART5 GND: Pin 30 of J1001

Prepare the Demo
================
1. Connect a Type-C USB cable between the host PC and the J1401 USB port on the target board.
...
3. Boot Linux BSP to u-boot, and load M core image from SD card to run.
   => load mmc 1:2 0x80000000 /examples/heterogeneous-multicore/rpmsg-uart-sharing-cm/release/rpmsg_uart_sharing.bin
