...
cmake -B build_debug -GNinja -DZEPHYR_MODULES="$CMSIS_PATH;$HAL_NXP_PATH" -DBOARD=imx95_evk/mimx9596/a55 -DCMAKE_BUILD_TYPE=Debug -DEXTRA_CONF_FILE=prj_debug.conf ../../../
ninja -C build_debug
