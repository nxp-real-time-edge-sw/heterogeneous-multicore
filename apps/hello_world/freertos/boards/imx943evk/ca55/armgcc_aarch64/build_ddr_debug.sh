...
# By default, LPUART1 is used for uboot and Linux, LPUART8 is used for M33-Core1 RTOS.
...
do
	...
	do
		...
		mv ${output_dir}/hello_world_${cpu}.bin ${output_dir}/${image_name}.bin
		mv ${output_dir}/hello_world_${cpu}.elf ${output_dir}/${image_name}.elf
	done
done
