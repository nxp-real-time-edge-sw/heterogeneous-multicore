...
struct os_counter_alarm_cfg {
	...
	uint32_t ticks;      /* number of ticks that triggers the alarm if OS_COUNTER_ALARM_CFG_ABSOLUTE is set, otherwise it is period ticks */
	uint32_t last_ticks; /* absolute ticks that trigger this time of alarm */
