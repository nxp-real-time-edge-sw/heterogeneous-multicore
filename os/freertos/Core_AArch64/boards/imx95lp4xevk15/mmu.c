...
static const struct ARM_MMU_region mmu_regions[] = {
	...
	MMU_REGION_FLAT_ENTRY("GIC",
			      GIC_DISTRIBUTOR_BASE, KB(1216),
			      MT_DEVICE_nGnRE | MT_P_RW_U_RW | MT_NS),

	MMU_REGION_FLAT_ENTRY("LPUART1",
			      LPUART1_BASE, KB(64),
			      MT_DEVICE_nGnRE | MT_P_RW_U_RW | MT_NS),

	MMU_REGION_FLAT_ENTRY("LPUART3",
			      LPUART3_BASE, KB(64),
			      MT_DEVICE_nGnRE | MT_P_RW_U_RW | MT_NS),
	...
	MMU_REGION_FLAT_ENTRY("MU3",
			      ...
			      MT_DEVICE_nGnRE | MT_P_RW_U_RW | MT_NS),
	MMU_REGION_FLAT_ENTRY("MU3 SRAM",
			      AON__MUI_A3__MUA_BASE + KB(4), KB(4),
			      MT_NORMAL_NC | MT_P_RW_U_RW | MT_NS),
#elif RTOSID == 1
	MMU_REGION_FLAT_ENTRY("MU4",
			      AON__MUI_A4__MUA_BASE, KB(4),
			      MT_DEVICE_nGnRE | MT_P_RW_U_RW | MT_NS),
	MMU_REGION_FLAT_ENTRY("MU4 SRAM",
			      AON__MUI_A4__MUA_BASE + KB(4), KB(4),
			      MT_NORMAL_NC | MT_P_RW_U_RW | MT_NS),
#elif RTOSID == 2
	MMU_REGION_FLAT_ENTRY("MU2",
			      AON__MUI_A2__MUA_BASE, KB(4),
			      MT_DEVICE_nGnRE | MT_P_RW_U_RW | MT_NS),
	MMU_REGION_FLAT_ENTRY("MU2 SRAM",
			      AON__MUI_A2__MUA_BASE + KB(4), KB(4),
			      MT_NORMAL_NC | MT_P_RW_U_RW | MT_NS),
#endif
